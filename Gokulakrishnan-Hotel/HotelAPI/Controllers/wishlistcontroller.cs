...
namespace HotelAPI.Controllers
{
    ...
    public class wishlistcontroller : ControllerBase
    {
        ...
        {
            // System.Console.WriteLine(wishlist.StayingFrom);
             var lastwishlist=ApplicationDBContext.wishlists.LastOrDefault();
             if (lastwishlist!=null)
             {

            var lastIDFNumber=lastwishlist?.WishlistID.Substring(4);
            ...
            wishlist.WishlistID="WSID"+ (id+1);
             }
             else{
            wishlist.WishlistID="WSID3001";
